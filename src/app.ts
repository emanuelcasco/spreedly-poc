...
app.post('/payments', async (req: express.Request, res: express.Response) => {
  console.log(':::');
  ...
  res.send({
    ...
    payment_id: req.body,
    date: new Date(),
    description: 'all this data is mocked!'
  });
  await axios.put(
    req.body.callback_url,
    {
      muid: '396675601599777868234',
      status: 'APPROVED',
      code: '00',
      description: 'Compra de status APPROVED de $0,05 en la tienda PRUEBA QR DIMO.',
      payment_id: '00dab19d-a366-4a5b-a5c4-83669259be78',
      date: new Date()
    },
    {
